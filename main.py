...
def testEnrollStudent():
    ...
    try:
        ...
        enrollment_result = course_enrollment.enroll_student(course_id, student_id)
...
def testCancelEnrollmentRequest():
    ...
    try:
        ...
        cancellation_result = course_enrollment.cancel_enrollment_request(course_id, student_id)
